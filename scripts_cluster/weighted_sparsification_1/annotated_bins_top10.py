...
for cell in ['GM12878','IMR90','HMEC','HUVEC']:
    ...
    for type_anno in ['boundaries','chiptop','compartments','repetitive_elements']:
        if type_anno=='boundaries':
            ...
            for modification in ['H3K27ac','H3K27me3','H3K4me1','H3K4me2','H3K4me3','H3K9ac','H3K9me3','H2A.Z']:
                if modification=='H3K9me3':
                    anno=annot(f'/shares/CIBIO-Storage/GROUPS/sharedCE/Leonardo/HiCONA/Rao_2014/annotations/{type_anno}/{cell}_{modification}_broadPeak_top10.bed',bins)
                    annos[f'{type_anno}_{modification}']=anno
                else:
                    anno=annot(f'/shares/CIBIO-Storage/GROUPS/sharedCE/Leonardo/HiCONA/Rao_2014/annotations/{type_anno}/{cell}_{modification}_narrowPeak_top10.bed',bins)
                    annos[f'{type_anno}_{modification}']=anno
        ...
        DF.to_csv(f'/shares/CIBIO-Storage/GROUPS/sharedCE/Leonardo/HiCONA/Rao_2014/sparse_graphs/weighted_sparsification/bins_annotated_{cell}_top10.bed',sep='\t',index=None)
