...
for cell in cells:
    for e in exp:
        ...
        pix=c.pixels()[:]
        filtered_df=pd.read_table(f'sparse_graphs/weighted_sparsification/{cell}_{e}_01.bed')
        pix=pix[pix['count']>1]
        ...
        pix_new.to_csv(f'sparse_graphs/weighted_sparsification/{idx}_{e}_filtered_pix_01.bed',sep='\t',index=None)
